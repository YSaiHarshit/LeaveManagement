                ...
                <header className="flex">
                            ...
                            <div className="flex">
                                <div className="items-center">
                                    <select className="ml-52 mt-6 appearance-none">
                                        ...
                                        {isOpen && (
                                            ...
                                            <ul className="w-52 absolute z-10 bg-white border border-gray-200 rounded-l-xl  shadow-lg">
                            ...
                            <div className=" flex space-x-5 ">
                                ...
                                <div className="relative bg-green-600 px-4 py-3 h-14 mt-4 rounded-full">
                                    ...
                                    <span className="absolute -top-1 -right-5 bg-red-500 text-white rounded-full px-2 py-1 border-white">
                                        6
                                    </span>
                                </div>
