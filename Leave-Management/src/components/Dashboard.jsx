    ...
    return (
        <div className="flex  min-h-screen bg-gray-200 ">
            ...
            <div className=" items-center bg-blue-900">
                 ...
                 <div className="ml-4">
                    <img src={Kris} alt="kris" className="cursor-pointer size-20 w-60"/>
                </div>
                ...
                <div className="block">
                    ...
                    <ul className="">
                        ...
                        <li className={`ml-6 rounded-md hover:bg-yellow-400 font-semibold mt-1 pl-4 px-2 py-1`}>
                            <Link to="" className="text-white " >
                                <li htmlFor="" className={`ml-1 flex text-white hover:text-black cursor-pointer`} onClick={InactiveButton}>
                    ...
                    <h2 className="ml-6 text-white text-sm">Recruitement</h2>
                    <ul>
                        <Link to="">
                            <li className={`ml-6 hover:bg-yellow-400 text-white hover:text-black rounded-md font-semibold pl-4 mt-2 p-1`} onClick={InactiveButton}>
                                <i className="fa-solid fa-briefcase text-2xl "></i>
                                <button htmlFor="" className="ml-3 text-xl cursor-pointer">Jobs</button>
                            </li>
                        </Link>


                        <Link to="">
                            <li className={`text-white hover:text-black hover:bg-yellow-400 rounded-md font-semibold pl-3 px-2 ml-4 p-1`} onClick={InactiveButton}>
                        ...
                        <h2 className="ml-6 mt-2 text-white text-sm">Organization</h2>

                        <Link to="">
                            <li className={`text-white hover:text-black hover:bg-yellow-400 mt-1 rounded-md font-semibold px-2 py-1 ml-4 mb-1 `} onClick={InactiveButton}>
                        ...
                        <Link to="">
                            <li className={`text-white hover:text-black mt-1 hover:bg-yellow-400 rounded-md font-semibold px-2 py-1 ml-4`} onClick={InactiveButton}>
                        ...
                        <Link to="">
                            <li className={` text-white hover:text-black hover:bg-yellow-400 mt-1 rounded-md font-semibold  px-2 py-1 ml-4`} onClick={InactiveButton}>
                        ...
                        <Link>
                            <li className="mt-1 text-white bg-red-500 hover:bg-red-700 rounded-md font-semibold px-2 py-1  text-center ml-8 w-64" onClick={ () =>openLogOutModal()}>
            ...
            { isLogOutVisible && <Logout setIsLogOutVisible= {setIsLogOutVisible} /> }
        </div >
